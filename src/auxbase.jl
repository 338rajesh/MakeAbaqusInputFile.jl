...
function add_constraint_equations(
    ...
    eqns_file = create_new_file(joinpath(save_dir, "constraint_eqn" * analysis_ID * ".inp"))
    ...
    for a_npair in npairs
        ...
        add_nset_on_instance(eqns_file, cnset_tag, instance_name, [a_npair.c_nodetag,])
        add_nset_on_instance(eqns_file, pnset_tag, instance_name, [a_npair.p_nodetag,])
        #
